...
"""
    ...
    Taken from https://github.com/corydolphin/flask-cors/blob/main/flask_cors/extension.py
...
class CORS(object):
    ...
    def init_app(self, app, **kwargs):
        ...
        cors_after_request = make_after_request_function(app, resources)
...
def make_after_request_function(app: Flask, resources):
        ...
        for res_regex, res_options in resources:
            if try_match(normalized_path, res_regex):
                ...
                with app.app_context():
                    res_options['origins'] = get_config('CORS_WHITELIST')
