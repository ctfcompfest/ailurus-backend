...
def handler_flagrotator_task(body: FlagrotatorTaskSchema, **kwargs):
    ...
    flag_path = "/home/samba-flag/flags/{}-t{}/flag.txt".format(chall.slug, team_id)
    ...
    try:
        ...
        ssh.exec_command("sudo -u samba-flag bash -c 'echo \"{flag_value}\" > {flag_path}'".format(flag_value=flag_value, flag_path=flag_path))
        ssh.close()
